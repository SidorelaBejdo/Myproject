<?php
    include("lidhja.php");
      ...
      //$mer= "select * from udhetimi LIMIT 3";
...
<html>
    ...
    <body>
      ...
      <button class="carousel-control-next" type="button" data-bs-target="#demo" data-bs-slide="next">
        ...
        <div  class="row  mt-5  ">
      <div class="col-lg-6 ">
        <img  src="rreth nesh.jpeg" style="width:80% ;" >
      </div>
      <div class="col-lg-6">
        <h3 ><b><i> Explor Travel Agency</i></b> </h3><br>
        <p>
          Explor Travel Agency eshte nje agjensi e mirenjohur e cila 
          operon prej vitesh ne kryeqytetin e Shqiperise.Kompania jonë
           ...
           turistike pergjate Shqiperis.
        </p><br>
        <a href="about.php" class="btn btn-secondary">Lexo me shume -></a>
      </div>
            ...
            <div class="row mt-5">
                <div class="col-lg-12">
                    <h1 class="text-center">Qytetet me te vizituara</h1>
